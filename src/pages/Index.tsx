...
const Index = () => {
  ...
  const loadChapterFormulas = async (filePath: string) => {
    setLoading(true);
    try {
      const response = await fetch(`/formulas/${filePath}`);
      if (!response.ok) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-green-400 bg-clip-text text-transparent mb-4 font-mono">
            JEE Formula Master
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Badge variant="outline" className="text-sm md:text-base px-3 md:px-4 py-2 border-purple-500/50 text-purple-300">
              <i className="fas fa-brain mr-2"></i>
              Smart Recall System
            </Badge>
            <Badge variant="outline" className="text-sm md:text-base px-3 md:px-4 py-2 border-blue-500/50 text-blue-300">
              <i className="fas fa-random mr-2"></i>
              Random Practice
            </Badge>
            <Badge variant="outline" className="text-sm md:text-base px-3 md:px-4 py-2 border-green-500/50 text-green-300">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <Card className="p-4 md:p-6 bg-gray-800/50 backdrop-blur-xl border-gray-700/50 shadow-2xl">
        ...
        {currentFormula && (
          <div className="max-w-4xl mx-auto">
            <Card className="p-6 md:p-8 bg-gradient-to-r from-gray-800/60 to-gray-900/60 backdrop-blur-xl border-gray-700/50 shadow-2xl transform hover:scale-[1.01] transition-all duration-300">
              {/* Question */}
              <div className="mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {!showAnswer ? (
                  <Button
                    ...
                    size="lg"
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 md:py-4 px-6 md:px-8 text-base md:text-lg shadow-lg transform hover:scale-105 transition-all duration-200"
                  >
                  ...
                  <Button
                    ...
                    size="lg"
                    className="bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white font-semibold py-3 md:py-4 px-6 md:px-8 text-base md:text-lg shadow-lg transform hover:scale-105 transition-all duration-200"
                  >
